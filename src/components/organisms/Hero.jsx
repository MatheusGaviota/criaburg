export default function Hero() {
    ...
    return (
        <div className="h-screen w-full bg-[url(https://res.cloudinary.com/dvjb2v4gp/image/upload/v1756183305/hero-background_jyncfc.png)] bg-cover flex items-center justify-center">
