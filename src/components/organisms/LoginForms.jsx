...
export default function LoginForms() {
    ...
    return (
        <div className="flex flex-col bg-foreground text-primary items-center justify-center mx-30 mt-30 mb-20 gap-y-10">
            <h3 className="text-2xl text-center pt-10 uppercase font-lexend">Entre em Sua Conta</h3>
            <div className="flex flex-col gap-y-10">
                ...
                <Link to={"/cadastro"} className="text-sm text-primary hover:underline self-start">Não tenho uma conta</Link>
            </div>
            <button className="bg-primary text-foreground py-2 px-20 mb-10">Login</button>
        </div>
    )
